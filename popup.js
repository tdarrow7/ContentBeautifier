...
function createRepresentationOfTree() {
    ...
    "display: flex; justify-content: flex-start; align-items: flex-end; position: fixed; flex-flow: row wrap; left: 0; top: 0; z-index: 50; background-color: white; padding: 3px;");
